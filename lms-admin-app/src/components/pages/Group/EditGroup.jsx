      ...
      <>
        ...
        <Box>
          <Flex
            ...
            pos="relative"
          >
            {isFetching || !group || !teachers || !subjects ? (
              <SpinnerComponent />
            ) : (
                  ...
                  >
                    <Formik
                      initialValues={{
                        ...
                        studentIds: group.appUsers
                          .filter(
                            (st) => !st.roles.some((r) => r == roles.Teacher)
                          )
                          .map((st) => st.id),
                        teacherId:
                          group.appUsers
                            .filter((au) =>
                              au.roles.some((r) => r == roles.Teacher)
                            )
                            .map((au) => au.id) ?? "",
                      }}
                              ...
                              {({ field, form }) => (
                                ...
                                >
                                  ...
                                  <Select
                                    ...
                                    defaultValue={{
                                      label: `${group.appUsers
                                        .filter((au) =>
                                          au.roles.some(
                                            (r) => r == roles.Teacher
                                          )
                                        )
                                        .map((au) => au.name)} ${group.appUsers
                                        .filter((au) =>
                                          au.roles.some(
                                            (r) => r == roles.Teacher
                                          )
